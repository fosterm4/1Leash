...
const Courses = (props) => (
  <Layout>
    ...
    <div className="ValhalaInfo">
      <h4>You may be asking us who are the Trainers... </h4>
      <p>Introducing: VALHALLA GUNDOGS and KENNELS</p>
      <img src={valhalla}/>
      <p>VALHALLA is home to one of the top short hair breeding programs in the country, some have even said it to rank #1. WIth the production of great genes comes the demand for GREAT TRAINERS. Valhallas “Gun Dog School of Excellence” is known for taking pups to fully functioning gundogs, but GUNDOGGIN is taking it up a notch. This program is meant to take any dog to the next level. This program will teach you how to make your guide’s dog ashamed</p>
    </div>
    <div className="RussInfo">
      <p>HEAD TRAINER:</p>
      <img src={Russ}/>
      <p>Russell MacLennan is a respected bird dog breeder, trainer and upland hunting guide. He began his amateur training career in 1989 with a black lab named Buddy. Since then he has trained all breeds of sporting dogs and their owners for performance in the field and basic obedience in the home.</p>
      <p>Russell is no stranger to competition, at age 14 he competed in the Colorado Pheasant Hunting Championships, hosted by Pheasants Forever. Along with the help of Sir Hershey of Surrey and Delery Guillory they won top honors. Since, Russell has trained for, and competed in a variety of competitions including:</p>
      <ul>
        <li>National Bird Dog Challenge Association</li>
        <li>A.K.C. hunt tests and horseback trials</li>
        <li>A.P.L.A. qualifiers and many local hunting trials</li>
        <li>Russell and his dog “Boo” own the record for the fastest time set in the Colorado Open Pheasant Hunting Championships. In 1997, Russell and “Boo” completed a six pheasant run in less than 5 minutes, posting one of the highest scores ever.</li>
      </ul>
